...
from final.utils.basic_utils import mkdirp, load_json, save_json, make_zipfile, dict_to_markdown
...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        parser.add_argument("--no_sort_results", action="store_true",
                            help="do not sort results, use this for moment_detr query visualization")
